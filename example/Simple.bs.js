...
function counterProgram_002(path, _, _$1) {
  if (path && !path[1]) {
...
function counterProgram_003(routeAction, _) {
...
Oolong.run(Js_primitive.some(Oolong_Internals.Router[/* hash */4](/* () */0)), counterProgram)((function (view) {
